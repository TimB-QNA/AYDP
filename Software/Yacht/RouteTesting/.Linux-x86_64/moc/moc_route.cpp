...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_route_t, stringdata) + ofs \
...
const QMetaObject route::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_route.data,
      qt_meta_data_route,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_route.stringdata))
