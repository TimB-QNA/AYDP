...
const QMetaObjectExtraData logOutput::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject logOutput::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_logOutput,
      qt_meta_data_logOutput, &staticMetaObjectExtraData }
};
